...
class RemoveMember extends Component {
    ...
    render() {
        ...
        return (
            <div>
               <center><label>Remove Member</label></center> 
                {show}
                <center><Button variant="outlined" size="small" color="secondary" disabled={this.state.disabled} onClick={() => this.props.removeMember(this.state.Ids)}>Remove</Button></center>
            </div>
        );
    }
}
